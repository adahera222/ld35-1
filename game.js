...
(function(){
  var ref$, concat, zipWith, map, filter, flatten, Key, FPS, RES, DIRS, parts, remove, fill, flop, gridAppend, degToRad, Point, Stage, Layer, Centerable, Character, Critter, drawArc, drawCircle, drawSemicircle, drawTriangle, R, pick, randomColor, Behavior, Snuffle, Shrine, Blok, emptyBlok, solidBlok, isInWall, Map, FlowerStack, Flower, Room, Game;
  ...
  parts = [["..x...x...", "..x.*.x...", "..x...x...", "..xxxxx...", "..x...x...", "..x...x...", "..x...x...", "..xxxxx...", "..xxxxx...", "..x...x...", "..x...x...", "..x...x...", "..xxxxx...", "..x...x...", "..x...x...", "..x...x..."], ["......x...", "......x...", "......x...", "......x...", "......x...", "xxxxxxxxxx", "xxxxxxxxxx", "xxxx*xxxxx", "xxxxxxxxxx", "xxxxxxxxxx", "......x...", "......x...", "......x...", "......x...", "......x..."]];
  ...
  Room = (function(){
    ...
    Room.empty = ['#ddd', '#ccc', '#ccc', false];
    Room.replaceSquares = function(grid){
      return map(map(constructor.replaceSquare), grid);
    };
    Room.replaceSquare = function(it){
      switch (it) {
      case 'x':
    ...
    function Room(width, height){
      var i$, to$, xi, flowerSpots, this$ = this instanceof ctor$ ? this : new ctor$;
      width == null && (width = 20);
      height == null && (height = 15);
      this$.mapping = pick(parts);
      for (i$ = 0, to$ = width / 10 - 1; i$ < to$; ++i$) {
        xi = i$;
        this$.mapping = gridAppend(this$.mapping, pick(parts));
      }
      this$.mapping = constructor.replaceSquares(flop(this$.mapping));
  ...
  Game = (function(){
    ...
    function Game(width, height, fps){
      var i$, len$, worldSize, stage, solid, addWall, this$ = this;
      this.width = width;
      this.height = height;
      this.fps = fps;
      ...
      Key.bind('a', function(){
        var pos, grid, empty, ref$, ref1$;
        pos = this$.player.center().grid();
        grid = this$.world.bg.children[0].cells;
        empty = ['white', 'white', 'white', false];
        grid[pos.x][pos.y] = emptyBlok(pos.x, pos.y);
        if ((ref$ = emptyBlok(pos.x + 1, pos.y)) != null) {
          if ((ref1$ = grid[pos.x + 1]) != null) {
            ref1$[pos.y] = ref$;
          }
        }
        if ((ref$ = emptyBlok(pos.x - 1, pos.y)) != null) {
        ...
        if ((ref$ = emptyBlok(pos.x, pos.y - 1)) != null) {
          grid[pos.x][pos.y - 1] = ref$;
        }
        if ((ref$ = emptyBlok(pos.x, pos.y + 1)) != null) {
          grid[pos.x][pos.y + 1] = ref$;
        }
        return this$.world.bg.children[0].updateWalls();
      });
      ...
      map(function(it){
        return addWall(it, stage.mapping);
      }, ['up', 'down\\', 'left', 'right']);
      this.loadRoom(stage);
    ...
    prototype.loop = function(){
      ...
      this.world.ctx.save();
      this.world.ctx.translate(this.width / 2 - this.player.x, 0);
      this.world.draw();
